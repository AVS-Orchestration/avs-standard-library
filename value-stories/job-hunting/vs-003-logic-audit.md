...
This story acts as the "Forensic Gatekeeper." It performs a strict cross-reference between the tailored draft and the ground-truth resume to eliminate hallucinations while maintaining strategic alignment.
...
context_manifest:
  ...
  - key: "strategic_plan"
    ...
    default_path: "my-job-hunt/outputs/01-open/Oracle_TPgM_Cloud-Apps/job-strategy.md"
  - key: "tailor_resume"
    description: "Draft of resume that is ready for the audit check.  Generated by vs-002."
    default_path: "my-job-hunt/outputs/01-open/Oracle_TPgM_Cloud-Apps/tailored-resume.md"
```
...
product:
  type: "Document"
  format: "Markdown"
  output_path: "my-job-hunt/outputs/01-open/Oracle_TPgM_Cloud-Apps/final-resume.md"
```
