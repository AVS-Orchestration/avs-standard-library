...
metadata:
  ...
  version: "0.1"
  author: "AVS Strategy"
  target_persona: "The Individual Contributor (Alex)"
```

## THE GOAL: The "North Star" for the Agentic-Agent
```yaml
goal:
  as_a: "The Individual Contributor (Alex)"
  i_want: "Ingest PR diff -> Draft initial code review comments focused on logic (not syntax)."
