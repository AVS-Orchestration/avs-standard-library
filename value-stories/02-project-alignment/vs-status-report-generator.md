...
goal:
  as_a: "The TPM (Alex)"
  i_want: "Ingest Jira backlog + Git commit log -> Synthesize 'Real Status' vs 'Reported Status.' Automate the 'Tuesday Status Report.'"
